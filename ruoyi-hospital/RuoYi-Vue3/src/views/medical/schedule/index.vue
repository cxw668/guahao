<template>
  <div class="app-container">
    <schedule-calendar v-if="isCalendarView" :doctor-options="doctorOptions" @back="goListView" />
    <template v-else>
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
        ...
        <el-form-item label="日期" prop="workDate">
          <el-date-picker v-model="queryParams.workDate" type="date" value-format="YYYY-MM-DD" placeholder="请选择日期"
        ...
        <el-form-item style="width: 100vw;">
          <div style="display: flex; width: calc(100% - 300px); align-items: center; justify-content: space-between;">
            <div class="left">
              <el-button type="primary" plain icon="Plus" @click="handleAdd">新增</el-button>
              <el-button type="success" plain icon="Calendar" @click="goCalendar">日历视图</el-button>
            </div>
            <div class="right">
      ...
      <el-dialog v-model="open" :title="title" width="760px" append-to-body>
        <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="日期" prop="workDate">
                <el-date-picker v-model="form.workDate" type="date" value-format="YYYY-MM-DD" placeholder="请选择日期"
                  style="width: 100%;" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="开始时间" prop="startTime">
                <el-time-picker v-model="form.startTime" value-format="HH:mm:ss" placeholder="开始时间"
                  style="width: 100%;" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="结束时间" prop="endTime">
                <el-time-picker v-model="form.endTime" value-format="HH:mm:ss" placeholder="结束时间"
                  style="width: 100%;" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
...
<script setup name="MedicalSchedule">
import ScheduleCalendar from './calendar.vue'
...
function getDoctorOptions() {
  listMedicalDoctors({ pageNum: 1, pageSize: 9999, status: 0 }).then(res => {
...
function goCalendar() {
  router.push({ path: route.path, query: { ...route.query, view: 'calendar' } })
}
